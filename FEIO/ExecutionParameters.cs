namespace FEIO
{
    ...
    public struct ExecutionParameters
    {
        ...
        /// </summary>
        /// <example>If crossoverRate is 0.2, there's a 20% chance that two individuals will generate offsprings.</example>
        public double crossoverRate;
        /// <summary>
        /// The mutation rate (0-1) of the GA.
        /// </summary>
        /// <example>If mutationRate is 0.2, there's a 20% chance that a child will be mutated.</example>
        public double mutationRate;
        /// <summary>
        /// The elitism rate (0-1) of the GA.
        /// </summary>
        /// <example>If elitismRate is 0.2, the top 20% individuals of each generation will be preserved for the following one.</example>
